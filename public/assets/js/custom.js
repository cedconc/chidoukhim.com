...
allNextBtn.on('click', function () {
      ...
      var curStep = $(this).closest(".setup-content"),
        ...
        //   curInputs = curStep.find("input[type='text']"),
          curInputs = curStep.find("input[type='text'],input[type='url'],input[type='radio'],input[type='date'],input[type='file'],select"),
          isValid = true;
      ...
      for(var i=0; i<curInputs.length; i++){
          if (!curInputs[i].validity.valid){
              ...
              console.log('longueur des inputs = ' + curInputs.length);
          }
      }

      if(isValid && id=="submit-btn"){
          $('#form').submit();
      }
...
****************************************************/
 ...
 //Document ready functions
    $document.ready(function () {
        ...
        $('#messenger-iframe').hide();
        $('#messenger-iframe-container').hide();
        $("p.error-p").hide();
    });

    $('#message-bull').click(function(){
        $('#messenger-iframe').show();
        $('#messenger-iframe-container').show();
    });
