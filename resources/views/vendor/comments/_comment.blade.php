...
<div id="comment-{{ $comment->getKey() }}" class="media">
    ...
    <div id="comment-img-div" style="width: 4.5rem; height: 4.5rem; overflow: hidden; background-image: url('{{ assets_base() }}{{ $comment->commenter->photo_1}}'); background-repeat: no-repeat; background-size: cover; background-position: 50% 50%; margin-right: 1rem; margin-bottom: 1rem;">
                    ...
                    <div class="modal-content">
                        <form method="POST" action="{{ route('comments.update', $comment->getKey()) }}">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" class="btn btn-sm btn-outline-success text-uppercase">{{ __('Envoyer') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
