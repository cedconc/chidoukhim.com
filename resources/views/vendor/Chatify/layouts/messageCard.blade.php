...
@if($viewType == 'default')
    ...
    <div>
        <div class="message-card">
            <div class="image-file chat-image" style="width: 250px; height: 150px;background-image: url('{{ assets_base() }}/storage/{{ config('chatify.attachments.folder') }}/{{ $attachment[0] }}')">
            </div>
        </div>
    </div>
    @endif
