                ...
                <div class="row  justify-content-center">
                    <div class="col-md-6">
                        <div class="login-1-form register-1-form clearfix text-center">
                            ...
                            <h4 class="title divider-3 text-white">{{ __("Réinitialiser votre mot de passe") }}</h4>
                            ...
                            <div class="section-field text-uppercase text-center mt-2"> <button type="submit" class="button btn-lg btn-theme full-rounded animated right-icn"><span>{{ __(" Demander le lien de réinitialisation") }}<i class="glyph-icon flaticon-hearts" aria-hidden="true"></i></span></button> </div>
