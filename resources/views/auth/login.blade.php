            ...
            <div class="row  justify-content-center">
              <div class="col-md-6">
                <div class="login-1-form register-1-form clearfix text-center">
                  ...
                  <h4 class="title divider-3 text-white">{{ __("Se connecter") }}</h4>
                  ...
                  <div class="section-field mb-3">
                    ...
                    <div class="section-field mb-3 text-right">
                ...
                <div class="section-field text-uppercase text-center mt-2"> <button type="submit" class="button btn-lg btn-theme full-rounded animated right-icn"><span>{{ __("S'identifier") }}<i class="glyph-icon flaticon-hearts" aria-hidden="true"></i></span></button> </div>
                  ...
                  <div class="section-field mt-2 text-center text-white">
                    <p class="lead mb-0"> {{ __('Vous avez un compte?') }} <a class="text-white" href="{{ route('register') }}"> <u> {{ __('Inscrivez-vous!') }} </u> </a></p>
