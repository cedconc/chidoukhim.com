...
{{ __("Nous vous demandons d’aller dans votre espace personnel chidouh via le boutton qui suit afin de consulter la demande du profil du Membre concerné en vue d’accepter la mise en chidouh ou de la refuser.") }}

@component('mail::button', ['url' =>  config('app.name')  . '/chidours'])
{{ __("Liste de Chidouh") }}
@endcomponent
